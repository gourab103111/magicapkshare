...
public class SignUp_Fragment extends Fragment implements OnClickListener
    ...
    private TextView login, titleTV, orTV, terms_conditionsText, subscribeText, privacyPolicyText;
    ...
    private String privacyPolicyString, privacyPolicyPageId;
...
//                            gmailLoginButton.setText(response.getJSONObject("data").getString("google_btn"));
                            ...
                            if(response.getJSONObject("data").has("privacy_text")) {
                                privacyPolicyText.setText(response.getJSONObject("data").getString("privacy_text"));
                            }
                            privacyPolicyString = response.getJSONObject("data").getString("privacy_text");
                            privacyPolicyPageId = response.getJSONObject("data").getString("privacy_page_id");
                            privacyPolicyText.setOnClickListener(new OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    adforest_showPrivacyPolicyDialog();
                                }
                            });
    ...
    private void adforest_showPrivacyPolicyDialog() {
        ...
        if (SettingsMain.isConnectingToInternet(getActivity())) {
            ...
            params.addProperty("page_id", privacyPolicyPageId);
                    ...
                    try {
                        if (responseObj.isSuccessful()) {
                            ...
                            if (response.getBoolean("success")) {
                                ...
                                terms_conditionsTitle.setText(privacyPolicyString);
