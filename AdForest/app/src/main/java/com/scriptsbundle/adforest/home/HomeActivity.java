...
import com.scriptsbundle.adforest.profile.Most_ViewedAds;
import com.scriptsbundle.adforest.profile.MyAds_Rejected;
...
import com.scriptsbundle.adforest.profile.MyAds;
import com.scriptsbundle.adforest.profile.MyAds_Favourite;
import com.scriptsbundle.adforest.profile.MyAds_Featured;
import com.scriptsbundle.adforest.profile.MyAds_Inactive;
...
import com.scriptsbundle.adforest.userAndSellers.SellersListFragment;
...
//    DatabaseReference myRef;
    ...
    String calledFromPackages = "false";
...
//        }
        ...
        if (settingsMain.getAppOpen()) {
            restService = UrlController.createService(RestService.class, getApplicationContext());
        ...
        if (settingsMain.getHomeBool()) {
            calledFromPackages = getIntent().getStringExtra("calledFRomPackages");
        } else {
            calledFromPackages = "false";
        }
        ...
        bundle.putString("calledFRomPackages", calledFromPackages);
...
//            }
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    SettingsMain.reload(currentFragment);
//                    SettingsMain.reload(HomeActivity.this, finalFragment);
                    swipeRefreshLayout.setRefreshing(false);
                    shimmerFrameLayout.stopShimmer();
                    shimmerFrameLayout.setVisibility(View.GONE);
        ...
        if (code == 2) {
            ...
            if (FragmentHome.Ad_post) {
                if (FragmentHome.hasEmail) {
                    ...
                    alert.setTitle(settingsMain.getAlertDialogTitle("info"));
                    alert.setCancelable(false);
                    alert.setMessage(FragmentHome.emailDialogTitle);
                    alert.setPositiveButton(FragmentHome.emailDialogConfirmBtn, (dialog, which) -> {
                        FragmentProfile fragmentProfile = new FragmentProfile();
                        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.frameContainer, fragmentProfile).addToBackStack(null).commit();
                        dialog.dismiss();
                    });
                    alert.setNegativeButton(FragmentHome.emailDialogCancelBtn, (dialogInterface, i) -> dialogInterface.dismiss());
                    alert.show();
                }
//                Intent intent = new Intent(HomeActivity.this, AddNewAdPost.class);
//                startActivity(intent);
            } else if (FragmentHomeMarvel.Ad_post) {
                if (FragmentHomeMarvel.hasEmail) {
                    AdsNDAnalytics();
                    Intent intent = new Intent(HomeActivity.this, AddNewAdPost.class);
                    startActivity(intent);
                    ...
                    alert.setTitle(settingsMain.getAlertDialogTitle("info"));
                    alert.setCancelable(false);
                    alert.setMessage(FragmentHomeMarvel.emailDialogTitle);
                    alert.setPositiveButton(FragmentHomeMarvel.emailDialogConfirmBtn, (dialog, which) -> {
                        FragmentProfile fragmentProfile = new FragmentProfile();
                        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.frameContainer, fragmentProfile).addToBackStack(null).commit();
                        dialog.dismiss();
                    });
                    alert.setNegativeButton(FragmentHomeMarvel.emailDialogCancelBtn, (dialogInterface, i) -> dialogInterface.dismiss());
                    alert.show();
                }
//                Intent intent = new Intent(HomeActivity.this, AddNewAdPost.class);
//                startActivity(intent);
                ...
                alert.setTitle(settingsMain.getAlertDialogTitle("info"));
                alert.setCancelable(false);
                alert.setMessage(Objects.equals(settingsMain.getHomeScreenStyle(), "home1") ? FragmentHome.Verfiedmessage : FragmentHomeMarvel.Verfiedmessage);
                alert.setPositiveButton(settingsMain.getAlertOkText(), (dialog, which) -> {
                    FragmentProfile fragmentProfile = new FragmentProfile();
                    FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.frameContainer, fragmentProfile).addToBackStack(null).commit();
