...
public interface RestService {
    ...
    //getBlocked Ads
    @POST("ad_post/all_blocked_ads/")
    Call<ResponseBody> postBlockedAds(
...
//endregion
    ...
    @POST("ad_post/report_user")
    Call<ResponseBody> postSendUserReport(
            @Body JsonObject sendUserReport,
            @HeaderMap Map<String, String> headers
    );
    ...
    @POST("ad_post/block_ad")
    Call<ResponseBody> postBlockAd(
            @Body JsonObject adId,
            @HeaderMap Map<String, String> headers
    );
    @POST("ad_post/unblock_ad")
    Call<ResponseBody> postUnBlockAd(
            @Body JsonObject adId,
            @HeaderMap Map<String, String> headers
    );
