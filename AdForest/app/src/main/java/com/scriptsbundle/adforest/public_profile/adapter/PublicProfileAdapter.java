package com.scriptsbundle.adforest.public_profile.adapter;
            ...
            public void onClick(View v) {
                try {
                    if (settingsMain.getUserLogin().equals("0")) {
                        Toast.makeText(mContext, settingsMain.getNoLoginMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                        onItemClickListener.onImgMoreItemClick(feedItem, v);
                    }
