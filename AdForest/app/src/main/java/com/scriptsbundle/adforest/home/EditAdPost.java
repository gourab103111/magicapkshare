...
//                            }
            ...
            try {
                String latValue = jsonObj.getJSONObject("map").getJSONObject("location_lat").getString("values");
                String longValue = jsonObj.getJSONObject("map").getJSONObject("location_long").getString("values");
                ...
                if (!latValue.isEmpty() && !longValue.isEmpty()) {
                    ...
                    System.err.println("Latitude or Longitude value is empty");
                }
...
//                myDateFormat.format(date)            }
    ...
    private void selectImage() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(EditAdPost.this);
