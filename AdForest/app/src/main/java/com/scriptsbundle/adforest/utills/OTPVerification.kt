...
class OTPVerification : AppCompatActivity(), View.OnFocusChangeListener, View.OnKeyListener,
    PhoneCallbacks.PhoneCallbacksListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(
            applicationContext,
            otpModel.getIs_number_verified_text(),
            Toast.LENGTH_SHORT
        )
        ...
        binding.submit.setOnClickListener {
            if (!binding.editTextone.text.isEmpty() && !binding.editTexttwo.text.isEmpty() &&
                ...
                verificationId.let {
                    var code =
                        binding.editTextone.text.toString() + binding.editTexttwo.text.toString() + binding.editTextthree.text.toString() + binding.editTextFour.text.toString() + binding.editTextFive.text.toString() + binding.editTextSix.text.toString()
                ...
                Toast.makeText(this, "Please enter valid otp verification code", Toast.LENGTH_SHORT)
                    .show()
            }
...
//            e.setText("")
    ...
    fun showDialog() {
        ...
        val view: View = inflater.inflate(R.layout.verified_successfully_dialog, null)

        val button = view.findViewById<Button>(R.id.ok)
        button.text = otpModel.phoneDialogStrings.btn_confirm // Assuming otpModel is defined elsewhere

        button.setBackgroundColor(Color.parseColor(SettingsMain.getMainColor())) // Assuming SettingsMain.getMainColor() returns a color in hexadecimal format
