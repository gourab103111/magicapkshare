...
//                customViewHolder.cardView.setAnimation(animation);
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(getApplicationContext(), com.kunzisoft.switchdatetime.R.anim.dialog_leave_to_right);//dialog_leave_to_right
