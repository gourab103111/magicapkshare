...
public final class ItemMainHomeRelatedVerticalBinding implements ViewBinding {
  @NonNull
  ...
  private ItemMainHomeRelatedVerticalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static ItemMainHomeRelatedVerticalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMainHomeRelatedVerticalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_main_home_related_vertical, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMainHomeRelatedVerticalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMainHomeRelatedVerticalBinding((CardView) rootView, cardView, cvCountdownView,
