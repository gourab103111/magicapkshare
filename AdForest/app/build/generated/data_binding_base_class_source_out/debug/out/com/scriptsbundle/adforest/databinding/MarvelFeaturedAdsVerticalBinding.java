...
public final class MarvelFeaturedAdsVerticalBinding implements ViewBinding {
  @NonNull
  ...
  private MarvelFeaturedAdsVerticalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      ...
      @NonNull TextView location, @NonNull TextView prices, @NonNull ImageView textView4,
  ...
  @NonNull
  public static MarvelFeaturedAdsVerticalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MarvelFeaturedAdsVerticalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.marvel_featured_ads_vertical, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MarvelFeaturedAdsVerticalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MarvelFeaturedAdsVerticalBinding((CardView) rootView, cardView, cvCountdownView,
