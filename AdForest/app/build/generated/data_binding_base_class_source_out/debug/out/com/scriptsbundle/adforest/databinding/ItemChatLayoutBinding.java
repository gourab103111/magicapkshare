...
public final class ItemChatLayoutBinding implements ViewBinding {
  ...
  private ItemChatLayoutBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemChatLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatLayoutBinding((RelativeLayout) rootView, bubbleLayoutParent, chatBubble,
