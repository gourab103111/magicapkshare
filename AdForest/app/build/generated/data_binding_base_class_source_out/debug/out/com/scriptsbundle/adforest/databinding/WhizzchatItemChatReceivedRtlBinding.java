...
public final class WhizzchatItemChatReceivedRtlBinding implements ViewBinding {
  @NonNull
  ...
  private WhizzchatItemChatReceivedRtlBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static WhizzchatItemChatReceivedRtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WhizzchatItemChatReceivedRtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.whizzchat_item_chat_received_rtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WhizzchatItemChatReceivedRtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WhizzchatItemChatReceivedRtlBinding((RelativeLayout) rootView, bubbleLayoutParent,
