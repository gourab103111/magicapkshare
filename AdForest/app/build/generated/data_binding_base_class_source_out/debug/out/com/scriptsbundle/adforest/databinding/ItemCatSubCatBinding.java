...
public final class ItemCatSubCatBinding implements ViewBinding {
  @NonNull
  ...
  private ItemCatSubCatBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      @NonNull CountdownView cvCountdownView, @NonNull TextView flow, @NonNull ImageView imageView,
      @NonNull LinearLayout linearLayoutCardView, @NonNull TextView location,
      @NonNull TextView prices, @NonNull TextView textViewName) {
  ...
  @NonNull
  public static ItemCatSubCatBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemCatSubCatBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_cat_sub_cat, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemCatSubCatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.flow;
      TextView flow = ViewBindings.findChildViewById(rootView, id);
      if (flow == null) {
        break missingId;
      }
      ...
      return new ItemCatSubCatBinding((CardView) rootView, cardView, cvCountdownView, flow,
          imageView, linearLayoutCardView, location, prices, textViewName);
    }
