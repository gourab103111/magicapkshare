...
public final class FragmentSendOffersBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSendOffersBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentSendOffersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSendOffersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_send_offers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSendOffersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSendOffersBinding((RelativeLayout) rootView, cardView, progressBar,
