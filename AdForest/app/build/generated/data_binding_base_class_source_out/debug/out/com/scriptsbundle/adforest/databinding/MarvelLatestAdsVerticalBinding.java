...
public final class MarvelLatestAdsVerticalBinding implements ViewBinding {
  @NonNull
  ...
  private MarvelLatestAdsVerticalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static MarvelLatestAdsVerticalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MarvelLatestAdsVerticalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.marvel_latest_ads_vertical, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MarvelLatestAdsVerticalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MarvelLatestAdsVerticalBinding((CardView) rootView, cardView, cvCountdownView,
