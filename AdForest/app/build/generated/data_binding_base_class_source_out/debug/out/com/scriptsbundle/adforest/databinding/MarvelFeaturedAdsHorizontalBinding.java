...
public final class MarvelFeaturedAdsHorizontalBinding implements ViewBinding {
  @NonNull
  ...
  private MarvelFeaturedAdsHorizontalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static MarvelFeaturedAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MarvelFeaturedAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.marvel_featured_ads_horizontal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MarvelFeaturedAdsHorizontalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MarvelFeaturedAdsHorizontalBinding((CardView) rootView, cardView, cvCountdownView,
