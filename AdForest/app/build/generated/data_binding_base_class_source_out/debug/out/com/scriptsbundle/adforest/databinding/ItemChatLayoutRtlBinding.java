...
public final class ItemChatLayoutRtlBinding implements ViewBinding {
  @NonNull
  ...
  private ItemChatLayoutRtlBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemChatLayoutRtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatLayoutRtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_layout_rtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatLayoutRtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatLayoutRtlBinding((RelativeLayout) rootView, bubbleLayoutParent, chatBubble,
          fileName, filesLayout, imageInner, imageLayout, message, profileImage, tvDate);
    }
