...
public final class ItemMainHomeRelatedBinding implements ViewBinding {
  ...
  private ItemMainHomeRelatedBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static ItemMainHomeRelatedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMainHomeRelatedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_main_home_related, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMainHomeRelatedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMainHomeRelatedBinding((CardView) rootView, cardView, cvCountdownView, date,
          imageView, linearLayoutCardView, ll1, location, prices, textView4, textViewName);
    }
