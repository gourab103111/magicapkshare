...
public final class FragmentMainHomeMarvelBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imgBtnFilter;
  ...
  @NonNull
  public final RelativeLayout searchBarRelative;
  ...
  private FragmentMainHomeMarvelBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull ImageView imgBgMain, @NonNull ImageButton imgBtnFilter,
      @NonNull ImageButton imgBtnLocation, @NonNull ImageButton imgBtnSearch,
      ...
      @NonNull RecyclerView recyclerView3, @NonNull RelativeLayout searchBarRelative,
      @NonNull RelativeLayout searchLayout, @NonNull ShimmerFrameLayout shimmerFrameLayout,
      @NonNull LinearLayout shimmerMain, @NonNull View simpleView, @NonNull TextView textView6,
      @NonNull TextView textView7, @NonNull TextView textView8, @NonNull TextView tvLocationName,
      @NonNull TextView tvLocationTitle, @NonNull TextView tvSearchSubTitle,
    ...
    this.imgBtnFilter = imgBtnFilter;
    this.imgBtnLocation = imgBtnLocation;
    ...
    this.searchBarRelative = searchBarRelative;
  ...
  @NonNull
  public static FragmentMainHomeMarvelBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMainHomeMarvelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_main_home_marvel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMainHomeMarvelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_btn_filter;
      ImageButton imgBtnFilter = ViewBindings.findChildViewById(rootView, id);
      if (imgBtnFilter == null) {
        break missingId;
      }

      id = R.id.img_btn_location;
      ImageButton imgBtnLocation = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.searchBarRelative;
      RelativeLayout searchBarRelative = ViewBindings.findChildViewById(rootView, id);
      if (searchBarRelative == null) {
        break missingId;
      }
      ...
      return new FragmentMainHomeMarvelBinding((NestedScrollView) rootView, HomeCustomLayout,
          activityMain, buttonAllCat, cardView, etSearch, featureAboveLayoutBelow,
          featureAboveLayoyut, featureLayoutMid, featuredRecylerViewBelow, featuredRecylerViewMid,
          homeTopLayout, imgBgMain, imgBtnFilter, imgBtnLocation, imgBtnSearch, linear1, linearCat,
          recyclerView, recyclerView2, recyclerView3, searchBarRelative, searchLayout,
          shimmerFrameLayout, shimmerMain, simpleView, textView6, textView7, textView8,
          tvLocationName, tvLocationTitle, tvSearchSubTitle, tvSearchTitle, viw);
    }
