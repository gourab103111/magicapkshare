...
public final class ItemComntListBinding implements ViewBinding {
  @NonNull
  ...
  private ItemComntListBinding(@NonNull RelativeLayout rootView, @NonNull CardView cardView,
      ...
      @NonNull TextView loginTime, @NonNull TextView prices, @NonNull RecyclerView sublist,
  ...
  @NonNull
  public static ItemComntListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemComntListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_comnt_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemComntListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemComntListBinding((RelativeLayout) rootView, cardView, imageView, iner1, iner2,
          iner3, linearLayoutCardView, loginTime, prices, sublist, textViewName, verified);
    }
