...
public final class MultiItemofFeatureSearchVerticalBinding implements ViewBinding {
  @NonNull
  ...
  private MultiItemofFeatureSearchVerticalBinding(@NonNull CardView rootView,
  ...
  @NonNull
  public static MultiItemofFeatureSearchVerticalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MultiItemofFeatureSearchVerticalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.multi_itemof_feature_search_vertical, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MultiItemofFeatureSearchVerticalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MultiItemofFeatureSearchVerticalBinding((CardView) rootView, cardView,
