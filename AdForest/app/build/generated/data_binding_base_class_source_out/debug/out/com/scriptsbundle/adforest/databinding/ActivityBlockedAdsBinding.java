...
public final class ActivityBlockedAdsBinding implements ViewBinding {
  ...
  private ActivityBlockedAdsBinding(@NonNull NestedScrollView rootView, @NonNull TextView addfav,
  ...
  @NonNull
  public static ActivityBlockedAdsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBlockedAdsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_blocked_ads, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBlockedAdsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBlockedAdsBinding((NestedScrollView) rootView, addfav, cardView, cardView1,
          imageView, imgMore, introduction, linearLayoutCardView, ll11, loginTime, mainRelative,
          mainScrollView, numberOfRate, progressBar4, publicProfileCustomIcons, ratingBar, report,
          rlMore, share, shimmerFrameLayout, shimmerMain, textIntroduction, textView19, textView5,
