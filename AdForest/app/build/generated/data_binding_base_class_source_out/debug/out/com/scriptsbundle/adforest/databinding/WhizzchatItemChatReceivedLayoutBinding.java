...
public final class WhizzchatItemChatReceivedLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private WhizzchatItemChatReceivedLayoutBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static WhizzchatItemChatReceivedLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WhizzchatItemChatReceivedLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.whizzchat_item_chat_received_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WhizzchatItemChatReceivedLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WhizzchatItemChatReceivedLayoutBinding((RelativeLayout) rootView,
          bubbleLayoutParent, chatBubble, fileDate, fileName, filesLayout, imageDate, imageInner,
          imageLayout, mapDate, mapLayout, mapView, message, tvDate);
    }
