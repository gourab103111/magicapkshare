...
public final class FragmentContactAdminBinding implements ViewBinding {
  ...
  private FragmentContactAdminBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout languageActiviy, @NonNull RelativeLayout mainRelative,
  ...
  @NonNull
  public static FragmentContactAdminBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentContactAdminBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_contact_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentContactAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactAdminBinding((RelativeLayout) rootView, languageActiviy,
          mainRelative, shimmerFrameLayout, shimmerMain, toolbar, webView);
    }
