...
public final class ActivitySearchBinding implements ViewBinding {
  ...
  private ActivitySearchBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageView collapse,
      @NonNull ImageView refresh, @NonNull Toolbar toolbar) {
  ...
  public static ActivitySearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.collapse;
      ImageView collapse = ViewBindings.findChildViewById(rootView, id);
      if (collapse == null) {
        break missingId;
      }
      ...
      return new ActivitySearchBinding((CoordinatorLayout) rootView, collapse, refresh, toolbar);
    }
