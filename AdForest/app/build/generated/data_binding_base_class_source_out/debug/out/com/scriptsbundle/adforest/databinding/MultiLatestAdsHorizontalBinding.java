...
public final class MultiLatestAdsHorizontalBinding implements ViewBinding {
  @NonNull
  ...
  private MultiLatestAdsHorizontalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static MultiLatestAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MultiLatestAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.multi_latest_ads_horizontal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MultiLatestAdsHorizontalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MultiLatestAdsHorizontalBinding((CardView) rootView, cardView, cvCountdownView,
