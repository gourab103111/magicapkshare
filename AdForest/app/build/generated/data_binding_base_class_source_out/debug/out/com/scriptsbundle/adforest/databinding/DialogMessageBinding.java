...
public final class DialogMessageBinding implements ViewBinding {
  ...
  private DialogMessageBinding(@NonNull RelativeLayout rootView, @NonNull Button cancelButton,
  ...
  public static DialogMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogMessageBinding((RelativeLayout) rootView, cancelButton, editText3,
          imageView4, linearLayout5, sendButton, textView3);
    }
