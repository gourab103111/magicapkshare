...
public final class ItemChatReceivedLayoutRtlBinding implements ViewBinding {
  @NonNull
  ...
  private ItemChatReceivedLayoutRtlBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemChatReceivedLayoutRtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatReceivedLayoutRtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_received_layout_rtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatReceivedLayoutRtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatReceivedLayoutRtlBinding((RelativeLayout) rootView, bubbleLayoutParent,
