...
public final class MarvelLatestAdsHorizontalBinding implements ViewBinding {
  @NonNull
  ...
  private MarvelLatestAdsHorizontalBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static MarvelLatestAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MarvelLatestAdsHorizontalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.marvel_latest_ads_horizontal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MarvelLatestAdsHorizontalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MarvelLatestAdsHorizontalBinding((CardView) rootView, cardView, cvCountdownView,
